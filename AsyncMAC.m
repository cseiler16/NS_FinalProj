...
% This example shows how to simulate the IEEE(R) 802.15.4(TM) asynchronous CSMA
% MAC [ <#10 1> ] using the Communications Toolbox(TM) Library for
% the ZigBee(R) Protocol.

% Copyright 2017-2018 The MathWorks, Inc.

%% Background
% The *IEEE 802.15.4* standard specifies the *MAC* and *PHY* layers of
% Low-Rate Wireless Personal Area Networks (*LR-WPANs*) [ <#10 1> ]. The
% IEEE 802.15.4 MAC and PHY layers provide the basis of other higher-layer
% standards, such as *ZigBee*, WirelessHart(R), 6LoWPAN and MiWi. Such
...
%
% The IEEE 802.15.4 MAC [ <#10 1> ] specifies two-basic MAC modes: _(i)_
...
% *acknowledgment* of an Association Request with an immediate transmission
...
% The data frames may be acknowledged, depending on their 'Acknowledgment
% Request' indication.

%% Asynchronous Medium-Access Control (MAC)
% The asynchronous CSMA IEEE 802.15.4 MAC is similar to the generic CSMA
% operation and the IEEE 802.11 MAC. In this MAC scheme, acknowledgment
...
% where BE is the backoff exponent. The duration of each backoff period is
...
% * Frame acknowledgments and frame retransmissions if acknowledgments
